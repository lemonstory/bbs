...
0
|| checktplrefresh('./template/jiuyue/touch/forum/viewthread.htm', './template/jiuyue/touch/forum/forumdisplay_fastpost.htm', 1450450220, 'diy', './data/template/2_diy_touch_forum_viewthread.tpl.php', './template/jiuyue', 'touch/forum/viewthread')
|| checktplrefresh('./template/jiuyue/touch/forum/viewthread.htm', './template/jiuyue/touch/common/seccheck.htm', 1450450220, 'diy', './data/template/2_diy_touch_forum_viewthread.tpl.php', './template/jiuyue', 'touch/forum/viewthread')
;?>
<?php $threadsort = $threadsorts = null;?><?php include template('common/header'); ?><!-- header start -->
<header class="header cl">
<a href="<?php if($_GET['fromguid'] == 'hot') { ?>forum.php?mod=guide&view=hot&page=<?php echo $_GET['page'];?><?php } else { ?>forum.php?mod=forumdisplay&fid=<?php echo $_G['fid'];?>&<?php echo rawurldecode($_GET[extra]);?><?php } ?>" class="back icon"></a>
    <span class="name"><?php echo strip_tags($_G['forum']['name']) ? strip_tags($_G['forum']['name']) : $_G['forum']['name'];?></span>
<span class="y icon post" id="replyid"></span>
</header>
<!-- header end -->
...
<h2>
   ...
   <ul class="authi" <?php if($post['first']) { ?> style=" border-bottom:1px solid #ddd"<?php } ?>>
<li class="grey">
<em>
...
<div class="message" <?php if($post['first']) { ?> style="margin-left:0px"<?php } ?>>
                	<?php if($post['warned']) { ?>
